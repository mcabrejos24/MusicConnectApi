export default function TermsOfUse() {
    ...
    return (
        <div className="content terms-of-use-page">
            <h1>TERMS OF USE</h1>
            ...
            <ol>            
                <li><a href="#1">AGREEMENT TO TERMS</a></li>
                <li><a href="#2">INTELLECTUAL PROPERTY RIGHTS</a></li>
                <li><a href="#3">USER REPRESENTATIONS</a></li>
                <li><a href="#4">PROHIBITED ACTIVITIES</a></li>
                <li><a href="#5">USER GENERATED CONTRIBUTIONS</a></li>
                <li><a href="#6">CONTRIBUTION LICENSE</a></li>
                <li><a href="#7">MOBILE APPLICATION LICENSE</a></li>
                <li><a href="#8">SUBMISSIONS</a></li>
                <li><a href="#9">THIRD-PARTY WEBSITE AND CONTENT</a></li>
                <li><a href="#10">SITE MANAGEMENT</a></li>
                <li><a href="#11">PRIVACY POLICY</a></li>
                <li><a href="#12">TERM AND TERMINATION</a></li>
                <li><a href="#13">MODIFICATIONS AND INTERRUPTIONS</a></li>
                <li><a href="#14">GOVERNING LAW</a></li>
                <li><a href="#15">DISPUTE RESOLUTION</a></li>
                <li><a href="#16">CORRECTIONS</a></li>
                <li><a href="#17">DISCLAIMER</a></li>
                <li><a href="#18">LIMITATIONS OF LIABILITY</a></li>
                <li><a href="#19">INDEMNIFICATION</a></li>
                <li><a href="#20">USER DATA</a></li>
                <li><a href="#21">ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</a></li>
                <li><a href="#22">CALIFORNIA USERS AND RESIDENTS</a></li>
                <li><a href="#23">MISCELLANEOUS</a></li>
                <li><a href="#24">CONTACT US</a></li>
            </ol>

            <h2 id="1">1. AGREEMENT TO TERMS</h2>

            <p>These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and Manuel Cabrejos, Giselle Cabrejos, Vijay Rachakonda ("Company," “we," “us," or “our”), concerning your access to and use of the https://playlistpair.netlify.app/ website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
            ...
            <ul>
                ...
                <li>Use any of the illustrations on this website (which were created by Manuel Jose Cabrejos Torres) in any way or for your own work. If you do, then you agree to give anything you gained (money, items, etc.) to the artist Manuel Jose Cabrejos Torres.</li>
                <li>Use any of the icons on this website (which were created by Manuel Jose Cabrejos Torres) in any way or for your own work. If you do, then you agree to give anything you gained (money, items, etc.) to the artist Manuel Jose Cabrejos Torres.</li>
            </ul>
            ...
            <h2 id="7">7. MOBILE APPLICATION LICENSE</h2>
            ...
            <h2 id="9">9. THIRD-PARTY WEBSITE AND CONTENT</h2>
            ...
            <h2 id="11">11. PRIVACY POLICY</h2>

            <p>We care about data privacy and security. Please review our Privacy Policy: https://playlistpair.netlify.app/privacy-policy. By using the Site, you agree to be bound by our Privacy Policy, which is incorporated into these Terms of Use. Please be advised the Site is hosted in the United States. If you access the Site from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Site, you are transferring your data to the United States, and you agree to have your data transferred to and processed in the United States.</p>


            <h2 id="12">12. TERM AND TERMINATION</h2>
            ...
            <h2 id="13">13. MODIFICATIONS AND INTERRUPTIONS</h2>
            ...
            <h2 id="15">15. DISPUTE RESOLUTION</h2>

            <p>Any legal action of whatever nature brought by either you or us (collectively, the “Parties” and individually, a “Party”) shall be commenced or prosecuted in the state and federal courts located in Guilford County, North Carolina, and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction and forum non conveniens with respect to venue and jurisdiction in such state and federal courts. Application of the United Nations Convention on Contracts for the International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) are excluded from these Terms of Use. In no event shall any claim, action, or proceeding brought by either Party related in any way to the Site be commenced more than one (1) years after the cause of action arose.</p>


            <h2 id="16">16. CORRECTIONS</h2>
            ...
            <h2 id="18">18. LIMITATIONS OF LIABILITY</h2>
            ...
            <h2 id="22">22. CALIFORNIA USERS AND RESIDENTS</h2>

            <p>If any complaint with us is not satisfactorily resolved, you can contact the Complaint Assistance Unit of the Division of Consumer Services of the California Department of Consumer Affairs in writing at 1625 North Market Blvd., Suite N 112, Sacramento, California 95834 or by telephone at (800) 952-5210 or (916) 445-1254.</p>


            <h2 id="23">23. MISCELLANEOUS</h2>
